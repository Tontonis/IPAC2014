...
\begin{itemize}
\begin{small}
\item{Table~\ref{tab:heating-mki-screen-designs} shows that for the proposed beam parameters for HL-LHC, the power loss calculated for the MKIs will be as high under these parameters as the power loss in the MKI8D pre-TS3}
